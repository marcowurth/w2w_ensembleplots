...
def main():
    ...
    #run = dict(year = 2020, month = 4, day = 19, hour = 12)
    
    domain = dict(method = 'centerpoint', radius = 1400, deltalat =   0, deltalon =   0,
                  lat = 48.0, lon =  9.0, name = 'europe')
    #domain = dict(method = 'centerpoint', radius = 2400, deltalat =   0, deltalon =   0,
    #              lat = -90, lon =  0, name = 'south pole')

    variable1=dict(name='wind_300hPa', unit='km/h', grid='icosahedral') #variable1 will be in shading
    variable2=dict(name='gph_300hPa', unit='gpdm', grid='latlon_0.25') #variable2 will be in contourlines
