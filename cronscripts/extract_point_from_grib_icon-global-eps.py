############################################################################
###  script for extracting point value data from icon-eps and saving it  ###
############################################################################
...
from w2w_ensembleplots.core.extract_point_from_grib import point_savetofile_iconglobaleps
...
def main(pointname):
    ...
    point_savetofile_iconglobaleps(pointnames, date, None, None, False, verbose)
