...
def main():
    ...
    variable1 = dict(name='theta_e_850hPa', unit=' ~S~o~N~C', grid='icosahedral', load_global_field=True)
    variable2 = dict(name='gph_850hPa', unit='gpdm', grid='latlon_0.1', load_global_field=True)
